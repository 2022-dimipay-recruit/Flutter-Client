...
final profileIntroduce = TextStyle(
    fontSize: 14, color: grayOne, fontFamily: 'Pretendard', fontWeight: FontWeight.w500);
...
final questionCircleIcon = TextStyle(
    color: Colors.white, fontFamily: "Pretendard", fontSize: 14, fontWeight: FontWeight.w500);
...
final changeProfileChangeProfileImg = TextStyle(
    fontSize: 14, color: purpleOne, fontFamily: 'Pretendard', fontWeight: FontWeight.w500);
final changeProfileChangeTextTitle = TextStyle(
    fontSize: 14, color: purpleOne, fontFamily: 'Pretendard', fontWeight: FontWeight.w500);
final changeProfileChangeTextLength = TextStyle(
    fontSize: 14, color: Colors.black, fontFamily: 'Pretendard', fontWeight: FontWeight.w500);
...
final purpleSwitch = TextStyle(
    fontSize: 12, fontFamily: 'Pretendard', fontWeight: FontWeight.w500);
final actionBtn = TextStyle(
    fontSize: 12, color: grayOne, fontFamily: 'Pretendard', fontWeight: FontWeight.w500);
final simpleListBtn = TextStyle(
    fontSize: 14, color: Colors.black, fontFamily: 'Pretendard', fontWeight: FontWeight.w500);
final detailListBtnTitle = TextStyle(
    fontSize: 14, color: purpleOne, fontFamily: 'Pretendard', fontWeight: FontWeight.w500);
